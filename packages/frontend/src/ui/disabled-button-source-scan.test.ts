...
const APPROVED_EXCEPTIONS: ApprovedException[] = [
  ...
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1272, 'button', 'editingSubmitting', 'visible loading copy', 'Editing submit state is visible in the composer while attachment removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1288, 'button', 'editingSubmitting', 'visible loading copy', 'Editing submit state is visible in the composer while attachment removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1313, 'button', 'editingSubmitting', 'visible loading copy', 'Editing submit state is visible in the composer while attachment removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1331, 'button', 'editingSubmitting', 'visible loading copy', 'Editing submit state is visible in the composer while attachment removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1355, 'button', 'uploading', 'visible loading copy', 'Upload progress is visible in the composer while removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1373, 'button', 'uploading', 'visible loading copy', 'Upload progress is visible in the composer while removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 7152, 'button', 'editingMessage?.isSubmitting', 'visible loading copy', 'Edit controls show the saving state while the edited message is submitting.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 7914, 'Button', 'pickingPresetDirectoryKey !== null', 'explicit justified exemption', 'Clear directory is disabled only while another directory picker operation owns the modal.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 9283, 'button', 'renameConversationSaving', 'visible loading copy', 'Rename modal save button shows "Saving..." while close/cancel are paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 9309, 'Button', 'renameConversationSaving', 'visible loading copy', 'Rename modal save button shows "Saving..." while cancel is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 9317, 'Button', 'renameConversationSaving || !renamingConversation.value.trim()', 'nearby validation/help text', 'Rename input is immediately above the submit button and save text changes to "Saving..." during submit.'),
  ...
  it('produces an auditable inventory for every remaining conditional disabled button', () => {
    ...
    expect(inventory).toMatchInlineSnapshot(`
      [
        ...
        "packages/frontend/src/pages/AgentsPage.tsx:1245 <button> disabled={editingSubmitting} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:1272 <button> disabled={editingSubmitting} -> visible loading copy - Editing submit state is visible in the composer while attachment removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1288 <button> disabled={editingSubmitting} -> visible loading copy - Editing submit state is visible in the composer while attachment removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1313 <button> disabled={editingSubmitting} -> visible loading copy - Editing submit state is visible in the composer while attachment removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1331 <button> disabled={editingSubmitting} -> visible loading copy - Editing submit state is visible in the composer while attachment removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1355 <button> disabled={uploading} -> visible loading copy - Upload progress is visible in the composer while removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1373 <button> disabled={uploading} -> visible loading copy - Upload progress is visible in the composer while removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1410 <button> disabled={composerDisabled || uploading || editingSubmitting || (!isEditing && streaming) || attachmentLimitReached} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:1431 <button> disabled={composerDisabled || uploading || editingSubmitting || (!isEditing && streaming) || attachmentLimitReached} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:1490 <button> disabled={composerDisabled || uploading || editingSubmitting || (isEditing ? !canSubmitEdit : !composerValue.trim() && draftStagedAttachments.length === 0)} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:2703 <ReasonedActionButton> disabled={importingLegacy || status?.runner?.state === 'unavailable'} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:6612 <ReasonedActionButton> disabled={!newGroupName.trim()} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:6873 <button> disabled={visibleMessages.length === 0} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7040 <button> disabled={(msg.siblingIndex ?? 0) === 0} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7073 <button> disabled={(msg.siblingIndex ?? 0) >= (msg.siblingCount ?? 1) - 1} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7152 <button> disabled={editingMessage?.isSubmitting} -> visible loading copy - Edit controls show the saving state while the edited message is submitting.",
        "packages/frontend/src/pages/AgentsPage.tsx:7207 <button> disabled={isTranscriptExecutionBusy || editingMessage?.isSubmitting} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7435 <button> disabled={!activeConversationRun || stoppingRun} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7557 <button> disabled={isQueuedItemBusy || editingMessage?.isSubmitting} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7598 <button> disabled={isQueuedItemBusy || editingMessage?.isSubmitting} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7893 <ReasonedActionButton> disabled={pickingPresetDirectoryKey !== null || Boolean(runnerFilesystemDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:7914 <Button> disabled={pickingPresetDirectoryKey !== null} -> explicit justified exemption - Clear directory is disabled only while another directory picker operation owns the modal.",
        "packages/frontend/src/pages/AgentsPage.tsx:8185 <ReasonedActionButton> disabled={creating || cliMissing} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:8453 <ReasonedActionButton> disabled={verifyingRepositoryRootAgentId === settingsAgent.id || Boolean(runnerFilesystemDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:8501 <ReasonedActionButton> disabled={preparingRunnerWorkspaceAgentId === settingsAgent.id || Boolean(runnerFilesystemDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:8585 <ReasonedActionButton> disabled={agentEnvVarFormOpen && !agentEnvVarForm.id} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:8677 <ReasonedActionButton> disabled={agentEnvVarSaving} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:8790 <button> disabled={cronSaving} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:8824 <button> disabled={cronSaving} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:8868 <ReasonedActionButton> disabled={!cronFormCron.trim() || !cronFormPrompt.trim() || cronSaving} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:9113 <button> disabled={!mgrFormName.trim() || !mgrHasDirtyForm || mgrSaving} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:9179 <button> disabled={!mgrFormName.trim() || mgrSaving} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:9283 <button> disabled={renameConversationSaving} -> visible loading copy - Rename modal save button shows "Saving..." while close/cancel are paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:9309 <Button> disabled={renameConversationSaving} -> visible loading copy - Rename modal save button shows "Saving..." while cancel is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:9317 <Button> disabled={renameConversationSaving || !renamingConversation.value.trim()} -> nearby validation/help text - Rename input is immediately above the submit button and save text changes to "Saving..." during submit.",
        ...
        "packages/frontend/src/pages/boards/BoardsListPage.tsx:491 <ReasonedActionButton> disabled={creating || !createName.trim()} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/boards/BoardsListPage.tsx:594 <button> disabled={deletingBoardId === board.id} -> hover/focus tooltip via ActionTooltip",
        ...
        "packages/frontend/src/pages/collections/CollectionsListPage.tsx:395 <ReasonedActionButton> disabled={creating || !createName.trim()} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/collections/CollectionsListPage.tsx:467 <button> disabled={deletingCollectionId === collection.id} -> hover/focus tooltip via ActionTooltip",
