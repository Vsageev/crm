...
const APPROVED_EXCEPTIONS: ApprovedException[] = [
  ...
  exception('packages/frontend/src/pages/boards/BoardBatchRunPanel.tsx', 646, 'button', 'maxParallel <= 1', 'native boundary semantics', 'Numeric stepper decrement is disabled at the lower bound.'),
  exception('packages/frontend/src/pages/boards/BoardBatchRunPanel.tsx', 656, 'button', 'maxParallel >= 10', 'native boundary semantics', 'Numeric stepper increment is disabled at the upper bound.'),
  ...
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1277, 'button', 'editingSubmitting', 'visible loading copy', 'Editing submit state is visible in the composer while attachment removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1293, 'button', 'editingSubmitting', 'visible loading copy', 'Editing submit state is visible in the composer while attachment removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1318, 'button', 'editingSubmitting', 'visible loading copy', 'Editing submit state is visible in the composer while attachment removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1336, 'button', 'editingSubmitting', 'visible loading copy', 'Editing submit state is visible in the composer while attachment removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1360, 'button', 'uploading', 'visible loading copy', 'Upload progress is visible in the composer while removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 1378, 'button', 'uploading', 'visible loading copy', 'Upload progress is visible in the composer while removal is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 7392, 'button', 'editingMessage?.isSubmitting', 'visible loading copy', 'Edit controls show the saving state while the edited message is submitting.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 8142, 'Button', 'pickingPresetDirectoryKey !== null', 'explicit justified exemption', 'Clear directory is disabled only while another directory picker operation owns the modal.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 9510, 'button', 'renameConversationSaving', 'visible loading copy', 'Rename modal save button shows "Saving..." while close/cancel are paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 9536, 'Button', 'renameConversationSaving', 'visible loading copy', 'Rename modal save button shows "Saving..." while cancel is paused.'),
  exception('packages/frontend/src/pages/AgentsPage.tsx', 9544, 'Button', 'renameConversationSaving || !renamingConversation.value.trim()', 'nearby validation/help text', 'Rename input is immediately above the submit button and save text changes to "Saving..." during submit.'),
  ...
  exception('packages/frontend/src/components/FileBrowser.tsx', 1060, 'button', 'uploading', 'visible loading copy', 'File upload control shows active upload state while the input trigger is disabled.'),
  ...
  it('produces an auditable inventory for every remaining conditional disabled button', () => {
    ...
    expect(inventory).toMatchInlineSnapshot(`
      [
        ...
        "packages/frontend/src/components/FileBrowser.tsx:1007 <ReasonedActionButton> disabled={Boolean(bulkDeleteDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/components/FileBrowser.tsx:1060 <button> disabled={uploading} -> visible loading copy - File upload control shows active upload state while the input trigger is disabled.",
        "packages/frontend/src/components/FileBrowser.tsx:1085 <ReasonedActionButton> disabled={Boolean(uploadDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/components/FileBrowser.tsx:1143 <ReasonedActionButton> disabled={Boolean(createFolderDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/components/FileBrowser.tsx:1227 <button> disabled={Boolean(renameDisabledReason)} -> hover/focus tooltip via ActionTooltip",
        ...
        "packages/frontend/src/components/ProjectRunnersPanel.tsx:182 <ReasonedActionButton> disabled={Boolean(connectDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/components/RunnerConnectionList.tsx:126 <button> disabled={Boolean(renameDisabledReason)} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/components/RunnerConnectionList.tsx:146 <button> disabled={device.revoked} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/components/RunnerConnectionList.tsx:162 <button> disabled={device.revoked} -> hover/focus tooltip via ActionTooltip",
        ...
        "packages/frontend/src/pages/AgentsPage.tsx:1250 <button> disabled={editingSubmitting} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:1277 <button> disabled={editingSubmitting} -> visible loading copy - Editing submit state is visible in the composer while attachment removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1293 <button> disabled={editingSubmitting} -> visible loading copy - Editing submit state is visible in the composer while attachment removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1318 <button> disabled={editingSubmitting} -> visible loading copy - Editing submit state is visible in the composer while attachment removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1336 <button> disabled={editingSubmitting} -> visible loading copy - Editing submit state is visible in the composer while attachment removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1360 <button> disabled={uploading} -> visible loading copy - Upload progress is visible in the composer while removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1378 <button> disabled={uploading} -> visible loading copy - Upload progress is visible in the composer while removal is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:1415 <button> disabled={composerDisabled || uploading || editingSubmitting || attachmentLimitReached} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:1435 <button> disabled={composerDisabled || uploading || editingSubmitting || attachmentLimitReached} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:1493 <button> disabled={composerDisabled || uploading || editingSubmitting || (isEditing ? !canSubmitEdit : !composerValue.trim() && draftStagedAttachments.length === 0)} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:2738 <ReasonedActionButton> disabled={importingLegacy || status?.runner?.state === 'unavailable'} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:6776 <ReasonedActionButton> disabled={!newGroupName.trim()} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:7060 <button> disabled={visibleMessages.length === 0} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7275 <button> disabled={(msg.siblingIndex ?? 0) === 0} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7308 <button> disabled={(msg.siblingIndex ?? 0) >= (msg.siblingCount ?? 1) - 1} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7392 <button> disabled={editingMessage?.isSubmitting} -> visible loading copy - Edit controls show the saving state while the edited message is submitting.",
        "packages/frontend/src/pages/AgentsPage.tsx:7447 <button> disabled={isTranscriptExecutionBusy || editingMessage?.isSubmitting} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7675 <button> disabled={!activeConversationRun || stoppingRun} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7797 <button> disabled={isQueuedItemBusy || editingMessage?.isSubmitting} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:7838 <button> disabled={isQueuedItemBusy || editingMessage?.isSubmitting} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:8121 <ReasonedActionButton> disabled={pickingPresetDirectoryKey !== null || Boolean(runnerFilesystemDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:8142 <Button> disabled={pickingPresetDirectoryKey !== null} -> explicit justified exemption - Clear directory is disabled only while another directory picker operation owns the modal.",
        "packages/frontend/src/pages/AgentsPage.tsx:8413 <ReasonedActionButton> disabled={creating || cliMissing} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:8680 <ReasonedActionButton> disabled={verifyingRepositoryRootAgentId === settingsAgent.id || Boolean(runnerFilesystemDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:8728 <ReasonedActionButton> disabled={preparingRunnerWorkspaceAgentId === settingsAgent.id || Boolean(runnerFilesystemDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:8812 <ReasonedActionButton> disabled={agentEnvVarFormOpen && !agentEnvVarForm.id} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:8904 <ReasonedActionButton> disabled={agentEnvVarSaving} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:9017 <button> disabled={cronSaving} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:9051 <button> disabled={cronSaving} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:9095 <ReasonedActionButton> disabled={!cronFormCron.trim() || !cronFormPrompt.trim() || cronSaving} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/AgentsPage.tsx:9340 <button> disabled={!mgrFormName.trim() || !mgrHasDirtyForm || mgrSaving} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:9406 <button> disabled={!mgrFormName.trim() || mgrSaving} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/AgentsPage.tsx:9510 <button> disabled={renameConversationSaving} -> visible loading copy - Rename modal save button shows "Saving..." while close/cancel are paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:9536 <Button> disabled={renameConversationSaving} -> visible loading copy - Rename modal save button shows "Saving..." while cancel is paused.",
        "packages/frontend/src/pages/AgentsPage.tsx:9544 <Button> disabled={renameConversationSaving || !renamingConversation.value.trim()} -> nearby validation/help text - Rename input is immediately above the submit button and save text changes to "Saving..." during submit.",
        ...
        "packages/frontend/src/pages/boards/BoardBatchRunPanel.tsx:646 <button> disabled={maxParallel <= 1} -> native boundary semantics - Numeric stepper decrement is disabled at the lower bound.",
        "packages/frontend/src/pages/boards/BoardBatchRunPanel.tsx:656 <button> disabled={maxParallel >= 10} -> native boundary semantics - Numeric stepper increment is disabled at the upper bound.",
        "packages/frontend/src/pages/boards/BoardBatchRunPanel.tsx:699 <ReasonedActionButton> disabled={Boolean(disabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        ...
        "packages/frontend/src/pages/boards/BoardExecutionPlansPanel.tsx:543 <button> disabled={!canRun} -> hover/focus tooltip via ActionTooltip",
        "packages/frontend/src/pages/boards/BoardExecutionPlansPanel.tsx:620 <ReasonedActionButton> disabled={!canRunEditingPlan} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/boards/BoardExecutionPlansPanel.tsx:630 <ReasonedActionButton> disabled={!canSave} -> hover/focus tooltip via ReasonedActionButton",
        ...
        "packages/frontend/src/pages/boards/BoardsListPage.tsx:464 <ReasonedActionButton> disabled={creating || !createName.trim()} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/boards/BoardsListPage.tsx:567 <button> disabled={deletingBoardId === board.id} -> hover/focus tooltip via ActionTooltip",
        ...
        "packages/frontend/src/pages/collections/CollectionsListPage.tsx:419 <ReasonedActionButton> disabled={creating || !createName.trim()} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/collections/CollectionsListPage.tsx:491 <button> disabled={deletingCollectionId === collection.id} -> hover/focus tooltip via ActionTooltip",
        ...
        "packages/frontend/src/pages/settings/RunnerDevicesTab.tsx:226 <ReasonedActionButton> disabled={Boolean(connectDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
        "packages/frontend/src/pages/settings/RunnerDevicesTab.tsx:267 <ReasonedActionButton> disabled={Boolean(connectDisabledReason)} -> hover/focus tooltip via ReasonedActionButton",
